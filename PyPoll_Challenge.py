...
file_to_save = os.path.join("analysis", "PyPoll_Challenge_Analysis.txt")
...
#defining an empty list for counties
counties=[]
#defining an empty dictionary for counties and votes
county_votes={}
...
#defining empty string for county with largest turnout
winning_county = ""
#define the start value of county votes
winning_county_votes=0
#Defining largest county variable
largest_county = ""
...
with open(file_to_save, "w") as txt_file:
    ...
    for counties in county_votes:
        ...
        vote_count = county_votes[counties]
    ...
    #Loop through candidate names in data
